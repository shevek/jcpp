...
/**
 * File reader that waits before opening the file for real, in order to save file handles.
 * (including entire Objective-C frameworks can make us run out of handles!)
 */
